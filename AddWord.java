...
import javax.swing.JScrollPane;
 ...
 public class AddWord extends JFrame
 {
	 ...
	 public AddWord()
	 {
			 ...
			 public void actionPerformed(ActionEvent e)
			 {
				 if((AddWord.this.tfWord.getText().length()>0)&&(AddWord.this.taMeaning.getText().length()>0))
				 {
					 ...
					 AddWord.this.taMeaning.setText("");
					  ...
					  JOptionPane.showMessageDialog(AddWord.this,"Added Word Successfully! ---> ","Add Word",0);
			}
			else{
				JOptionPane.showMessageDialog(AddWord.this,"Please Enter Word And Meanning! --->","Add Word",0);
			}}
		});
		...
		gbc.gridx=0;
		gbc.anchor=13;
		c.add(new JLabel("Enter Meanning:"),gbc);
		gbc.anchor=17;
		gbc.gridx=1;
		gbc.gridwidth=2;
		gbc.gridheight=2;
